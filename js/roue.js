...
var wheel = {
    ...
    colors: ['#003366', '#FF6600', '#CCCC00', '#006600', '#3333CC', '#CC0066', '#FF3300', '#009900', '#6600CC', '#33CC33', '#0066CC', '#FF0066', '#3300FF', '#00CC00', '#FFCC00','#CC00CC','#000000'],
    ...
    upTime: 300, // How long to spin up for (in ms)
    ...
    spin: function() {
      ...
      if (wheel.timerHandle == 0) {
        ...
        wheel.maxSpeed = Math.PI / (20 + Math.random()); // Randomly vary how hard the spin is
        wheel.frames = 0;
        wheel.sound.play();
