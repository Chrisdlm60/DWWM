...
class MondialRelay extends Module
{
    ...
    */
    ...
    {
        if ((!$this->registerHook('displayAfterCarrier') || !$this->registerHook('updateCarrier')
    ...
    */
    ...
    public function hookDisplayOrderDetail($params)
    {
        ...
        return $this->fetch('module:mondialrelay/views/templates/front/order_detail.tpl');
    }
    ...
    */
    public function hookHeader($params)
    {
        ...
        if (in_array($file, array('order-opc', 'order', 'orderopc', 'amzpayments'))) {
            ...
            $this->context->controller->registerJavascript($this->name.'-gmap-mr', 'https://unpkg.com/leaflet/dist/leaflet.js', array('server'=>'remote'));
            $this->context->controller->registerStylesheet($this->name.'-gmap-mr', 'https://unpkg.com/leaflet/dist/leaflet.css', array('server'=>'remote'));
            ...
            if (Configuration::get('MONDIAL_RELAY_MODE') == 'widget') {
                if (isset($this->context) && method_exists($this->context->controller, 'registerJavascript')) {
                    $this->context->controller->registerJavascript($this->name.'-gmap-mr', 'https://widget.mondialrelay.com/parcelshop-picker/jquery.plugin.mondialrelay.parcelshoppicker.min.js', array('server'=>'remote'));
