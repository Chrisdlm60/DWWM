...
*/
     ...
     * (for feasibility, feasibilities, expeditionCreation in hookDisplayCarrierExtraContent or saveShipment).
     *
...
*/
     ...
     * @return array|null
     */
    public function feasibilities($strArgReceiverZipCode, $strArgReceiverCity, $strArgReceiverType = null)
    {
        TNTOfficiel_Logstack::log();
