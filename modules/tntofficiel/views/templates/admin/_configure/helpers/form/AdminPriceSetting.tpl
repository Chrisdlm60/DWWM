                                ...
                                <div class="tab-content panel">
                                    {foreach $tntofficiel.arrZonesConfList as $intZoneConfID => $arrZoneConf}
                                        <div id="zone{$intZoneConfID|escape:'html':'UTF-8'}" class="tab-pane {if $arrZoneConf@iteration == 1}active{/if}">
                                            <p><strong>
                                                    {if ($intZoneConfID == 0)}
                                                        {l s='Entering the pricing for the Default Zone (Metropolitan France, excluding regional tariff zones 1 and 2)' mod='tntofficiel'} :
                                                    {else}
                                                        {l s='Entering pricing for the Regional Tariff Area' mod='tntofficiel'} {$intZoneConfID|escape:'html':'UTF-8'} :
                                                    {/if}
                                                </strong></p>
