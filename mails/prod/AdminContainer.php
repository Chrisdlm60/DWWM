...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : ($this->services['annotation_reader'] = new \Doctrine\Common\Annotations\AnnotationReader())) && false ?: '_'}, [0 => '/htdocs/prestarecup/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/htdocs/prestarecup/var/cache/prod//doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/htdocs/prestarecup/var/cache/prod//localization');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/htdocs/prestarecup/app',
            'kernel.project_dir' => '/htdocs/prestarecup',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/htdocs/prestarecup/var/cache/prod/',
            ...
            'ps_cache_dir' => '/htdocs/prestarecup/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/htdocs/prestarecup/var/cache/prod//doctrine/orm/Proxies',
