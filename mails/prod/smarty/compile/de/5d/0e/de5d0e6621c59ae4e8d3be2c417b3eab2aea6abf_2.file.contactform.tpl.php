...
/* Smarty version 3.1.34-dev-7, created on 2021-03-11 10:17:55
  from '/htdocs/prestarecup/themes/tech/modules/contactform/views/templates/widget/contactform.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6049e04343ecd5_75129943',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'de5d0e6621c59ae4e8d3be2c417b3eab2aea6abf' => 
    array (
      0 => '/htdocs/prestarecup/themes/tech/modules/contactform/views/templates/widget/contactform.tpl',
      1 => 1615390327,
      2 => 'file',
    ),
  ),
...
function content_6049e04343ecd5_75129943 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
      ...
      <div class="form-group row">
<label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Numéro de téléphone','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
    <?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['telephone'])) {?>
    <div class="col-md-6">
    <input type="text" class="form-control" id="telephone" name="telephone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customerThread']->value['telephone'], ENT_QUOTES, 'UTF-8');?>
" readonly="readonly" />
    </div>
    <?php } else { ?>
    <div class="col-md-6">
    <input type="text" class="form-control" id="telephone" name="telephone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['telephone']->value, ENT_QUOTES, 'UTF-8');?>
" /> 
    </div>
    <?php }?>
</div>
