...
{block name='page_title'}
  ...
  {l s='Mot de passe oublier?' d='Shop.Theme.CustomerAccount'}
...
{block name='page_content'}
  ...
  <form action="{$urls.pages.password}" method="post">
    ...
    <header>
      ...
      <p>{l s='Entrez votre adresse email. vous allez recevoir un mot de passe temporaire.' d='Shop.Theme.CustomerAccount'}</p>
